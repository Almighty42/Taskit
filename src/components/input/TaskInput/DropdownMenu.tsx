...
//onClick={() => { setColor('#949494');setBorder('#000000') }}
{/* <MenuItem value={10}><TaskPriorityIcon color='#949494' borderColor='#000000' /></MenuItem>
        <MenuItem value={20}><TaskPriorityIcon color='#FF4646' borderColor='#990000' /></MenuItem>
        <MenuItem value={30}><TaskPriorityIcon color='#FFA346' borderColor='#994D00' /></MenuItem>
        <MenuItem value={40}><TaskPriorityIcon color='#FFFF47' borderColor='#999900' /></MenuItem>
        <MenuItem value={50}><TaskPriorityIcon color='#47FF47' borderColor='#009900' /></MenuItem>
        <MenuItem value={60}><TaskPriorityIcon color='#149E14' borderColor='#062D06' /></MenuItem> */}
